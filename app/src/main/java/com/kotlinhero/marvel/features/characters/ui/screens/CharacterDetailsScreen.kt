...
import com.kotlinhero.marvel.core.ui.reusables.error.NetflixErrorBox
import com.kotlinhero.marvel.core.ui.reusables.image.NetworkImage
import com.kotlinhero.marvel.core.ui.reusables.loading.NetflixLoadingBox
...
import com.kotlinhero.marvel.features.characters.ui.components.CharacterAttributes
import com.kotlinhero.marvel.features.characters.ui.components.PublicationsLazyRow
            ...
            AnimatedContent(
                ...
                when (val fetchState = it) {
                    is FetchState.Error -> NetflixErrorBox(
                        ...
                        onClickTryAgain = viewModel::getCharacterDetails
                    )
